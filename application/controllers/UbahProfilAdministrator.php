...
class UbahProfilAdministrator extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('MUbahProfilAdministrator');
    }
    ...
    public function Update() {
        ...
        if ($pass1 == $pass2 && $pass1 != '' && $pass2 != '' && $nama != '' && $alamat != '' && $this->upload->do_upload('foto')) {
            ...
            $file = $name['file_name'];
            $this->MUbahProfilAdministrator->UpdateProfil($nama, $alamat, $email, $pass1, $file, $id);
            ...
            if ($query->num_rows() > 0) {
                ...
                foreach ($query->result() as $row) {
                    ...
                    redirect("HomeAdministrator",'refresh');
                }
            }
        } else {
