...
class UbahProfilFinance extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->load->model('MUbahProfilFinance');
    }
    ...
    public function Update() {
        ...
        if ($pass1 == $pass2 && $pass1 != '' && $pass2 != '' && $nama != '' && $alamat != '' && $this->upload->do_upload('foto')) {
            ...
            $file = $name['file_name'];
            $this->MUbahProfilFinance->UpdateProfil($nama, $alamat, $email, $pass1, $file, $id);
