...
class AdminTambahSiswa extends CI_Controller {
    ...
    public function insert() {
        ...
        if ($ada == 0) {
            if ($nama != '' && $username != '' && $tempat != '' && $tanggal != '' && $alamat != '' && $hp != '' && $jk != '' && $pass1 != '' && $kelas != 0 && $sekolah != '' && $this->upload->do_upload('foto')) {
                $this->load->library('upload', $config);
                ...
                redirect('AdminDataSiswa');
            } else if ($nama != '' && $username != '' && $tempat != '' && $tanggal != '' && $alamat != '' && $hp != '' && $jk != '' && $pass1 != '' && $kelas != 0 && $sekolah != '') {
                $this->db->query("insert into siswa values ($id,'$email','$username','$pass1','$nama','$satukan','$alamat','','$jk','$hp','$tempat','$sekolah',$kelas,'$now')");
                echo '<script>alert("Data Berhasil Ditambah");</script>';
                redirect('AdminDataSiswa','refresh');
            } else {
