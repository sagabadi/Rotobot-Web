...
class AdministratorEditSiswa extends CI_Controller {
    ...
    public function show($id) {
     ...
     $datas['detail'] = $detail;
     if ($cek  > 0) {            
        $this->load->view('administrator_edit_siswa.html', $datas);
    } else {            
        $this->load->view('administrator_edit_siswa_kosong.html', $data);
    }
}
